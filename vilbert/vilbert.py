...
class VILBertForVLTasks(BertPreTrainedModel):
    ...
    def forward(
        ...
        #print('shape1', vil_binary_prediction.shape, vil_binary_prediction)
        ...
        if False and pooled_output.size(0) % 2 == 0:
            vil_binary_prediction = self.vil_binary_prediction(
                pooled_output.view(-1, pooled_output.size(1) * 2)
            )
        #print('shape2', vil_binary_prediction.shape, vil_binary_prediction)
